pub(crate) const DMP_FIRWARE_BLOB: &[u8] = &[
    // DMP firmware blob copied from https://github.com/sparkfun/SparkFun_ICM-20948_ArduinoLibrary/blob/main/src/util/icm20948_img.dmp3a.h
    /* bank # 0 */
